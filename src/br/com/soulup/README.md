...
![Diagrama UML Geral](imagens/uml-geral.png)
...
![Diagrama UML de Herança - Ações](imagens/uml-heranca-acoes.png)

### 📌 Herança do Usuário

Diagrama de herança com `Usuario` como base e a subclasse `UsuarioPremium`:

![Diagrama UML de Herança - Usuário](imagens/uml-heranca-usuario.png)
